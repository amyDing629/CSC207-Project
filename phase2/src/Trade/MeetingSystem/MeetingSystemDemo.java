...
public class MeetingSystemDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        MyMeetingSystem mt1 = new MyMeetingSystem(tradeIds, true, meeting); // create a meeting system for the first meeting
        ...
        if (meeting.getStatus().equals(MeetingStatus.completed)) { // first meeting status: "completed"
            ...
            MyMeetingSystem mt2 = new MyMeetingSystem(tradeIds, false, meeting2); // create a meeting system for the second meeting
